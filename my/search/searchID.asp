...
<form id="frm" name="frm" method="post">
	...
	<input type="hidden" id="result_date" name="result_date" value="" />
</form>
...
<div id="contents" class="util">
	<div class="content">
		...
		<div class="input_area">
			<div class="tit">
				<h3>아이디 찾기<span>참가신청 시 입력한 본인 정보를 정확히 입력해 주세요.</span></h3>
			</div>
			<div class="sch_area">
						...
						<tr>
							...
							<td class="call">
								<div class="number_box">
									...
									<button type="button" id="aMobile" onclick="fnAuthSms(); return false;" style="cursor:pointer">인증번호 전송</button>
				...
				<div class="btn_area">
					<a href="javascript:" class="btn blue" onclick="onSubmit_ID('USER');">아이디 찾기</a>
				</div>
			</div><!-- sign_up -->
		</div>
	</div><!-- //content -->
