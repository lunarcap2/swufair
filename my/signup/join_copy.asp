		...
		<div class="input_area">
			...
			<div class="sign_up">
				...
				<div class="rdi_box">
					...
					<script>
					$(document).ready(function(){
						//$('.sign_up .tb .stu_id, .sign_up .tb .school_name').hide();
						$('#chkUnivArea').hide();
						$('#chkIdArea2').hide();	
...
//								$("input[name=gender]").eq(0).attr("checked", true);
								...
								$('#chkUnivArea').show();
								/*
								$('.sign_up .tb .id').hide().next('.sign_up .tb .stu_id').hide();
								$('.sign_up .tb .stu_id').hide().prev('.sign_up .tb .id').show();
								$('.sign_up .tb .school_name').show();
								*/
							}
						});
					});
						...
						<tr class="gender">
							...
							<td>
								<div class="rdi_box tb">
									<label class="radiobox" for="gender1">
										<input type="radio" class="rdi" id="rdoGender" name="rdoGender" value="1">
										<span>남학생</span>
									</label>
									<label class="radiobox" for="gender2">
										<input type="radio" class="rdi" id="rdoGender" name="rdoGender" value="2">
										<span>여학생</span>
									</label>	
								</div>
